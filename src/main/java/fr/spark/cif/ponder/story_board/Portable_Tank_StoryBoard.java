...
public class Portable_Tank_StoryBoard extends StoryBoard {
    public Portable_Tank_StoryBoard() {
        super("portable_tank/portable_tank");

        addScene(Portable_Tank_StoryBoard::use);
    }
