...
public class Industrial_Furnace_StoryBoard extends StoryBoard {

    public Industrial_Furnace_StoryBoard() {
        super("cif_furnace_all/cif_furnace_ponder");
        addScene(Industrial_Furnace_StoryBoard::build);
        addScene(Industrial_Furnace_StoryBoard::connection);
        addScene(Industrial_Furnace_StoryBoard::use);
        addScene(Industrial_Furnace_StoryBoard::automate);
        addScene(Industrial_Furnace_StoryBoard::utils);
    }

    private static void build(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    private static void connection(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    private static void use(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().of(5, 2, 4), Pointing.LEFT, 40)
                .rightClick()
    ...
    private static void automate(SceneBuilder builder, SceneBuildingUtil util){
    ...
    private static void arm(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    private static void utils(SceneBuilder builder, SceneBuildingUtil util) {
